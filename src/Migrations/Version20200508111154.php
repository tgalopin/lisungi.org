...
final class Version20200508111154 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE helpers (id BIGINT NOT NULL, uuid UUID NOT NULL, first_name VARCHAR(100) NOT NULL, last_name VARCHAR(100) NOT NULL, email VARCHAR(200) NOT NULL, locality VARCHAR(50) NOT NULL, company VARCHAR(100) DEFAULT NULL, phone VARCHAR(50) DEFAULT NULL, masks INT NOT NULL, glasses INT NOT NULL, blouses INT NOT NULL, gel INT NOT NULL, gloves INT NOT NULL, paracetamol INT NOT NULL, soap INT NOT NULL, food VARCHAR(250) DEFAULT NULL, other VARCHAR(250) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
